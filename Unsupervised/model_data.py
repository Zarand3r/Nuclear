...
nuclear_data = pd.read_csv("../output/measurements/Nucleus_BAF_Nuclei.csv")
...
#sub_nuc_data = nuclear_data[['AreaShape_Area','AreaShape_MeanRadius','Intensity_MeanIntensity_Enhanced_Inverted']]

#sub_nuc_data = nuclear_data[['AreaShape_Area','AreaShape_MeanRadius','AreaShape_Perimeter','Intensity_IntegratedIntensity_Enhanced_Inverted','Intensity_MeanIntensity_Enhanced_Inverted']]

#print sub_nuc_data
# print nuclear_data
frac_nuc_data  = sub_nuc_data.sample(n=5000)
...
f = plt.figure(1)
# plt.hist(X['AreaShape_MeanRadius'], density=True, bins=30)
plt.scatter(X['AreaShape_Perimeter'], X['Intensity_MeanIntensity_Enhanced_Inverted'], color="blue", s=10)
#plt.scatter(X['AreaShape_MeanRadius'], X['Intensity_MeanIntensity_Enhanced_Inverted'], color="blue", s=10)
